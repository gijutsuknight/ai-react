...
export interface CameraToolDialogProps {
  open: boolean;
  onClose: () => void;
}

export const CameraToolDialog: React.FC<CameraToolDialogProps> = ({
  open,
  onClose,
}) => {
  ...
  }, [open, stopStream, resetMedia]);

  return (
    <Dialog open={open} onClose={handleClose} maxWidth="md" fullWidth>
      <DialogTitle>Camera Tool</DialogTitle>
      <DialogContent>
        <Stack spacing={2}>
          <Typography variant="body2" color="text.secondary">
            Use this tool to access your webcam or phone camera, capture a
            photo or a 5-second video, download the result, and send it to your
          ...
          {uploadStatus === 'success' && (
            <Alert severity="success">
              Media uploaded successfully. Check your backend for the received
              file.
            </Alert>
          )}
